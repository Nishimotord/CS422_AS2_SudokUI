...
// curl -sL goo.gl/jUkahv | python - https://docs.google.com/forms/d/1OXcIuqah3KfMp5O67Zc3M7xsmsceQw9POSRPEZzOGN4/edit
//
...
// docs.google.com/forms/d/1OXcIuqah3KfMp5O67Zc3M7xsmsceQw9POSRPEZzOGN4/edit
function sendNetworkLog(uid, time, name, target, info, state, version) {
  var formid = "e/1FAIpQLSc8jjGZ00JvByAm9FCvTA_epWm8bFdSWjXom7uikaQJylo5CQ";
  var data = {
    "entry.528007014": uid,
    "entry.1837709055": time,
    "entry.1290428024": name,
    "entry.436155135": target,
    "entry.184103010": info,
    "entry.1778928240": state,
    "entry.1406834058": version
  };
  var params = [];
  for (key in data) {
